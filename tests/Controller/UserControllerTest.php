...
class UserControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            ...
            'user[confirmer_motdepasse]' => 'Testing',
            'user[image]' => 'Testing',
        ]);
    ...
    public function testShow(): void
    {
        ...
        $fixture->setConfirmer_motdepasse('My Title');
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            ...
            'user[confirmer_motdepasse]' => 'Something New',
        ...
        self::assertSame('Something New', $fixture[0]->getConfirmer_motdepasse());
