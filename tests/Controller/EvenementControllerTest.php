...
class EvenementControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            ...
            'evenement[evenement_date]' => 'Testing',
        ]);
    ...
    public function testShow(): void
    {
        ...
        $fixture->setEvenement_date('My Title');
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            ...
            'evenement[evenement_date]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getEvenement_date());
    }
