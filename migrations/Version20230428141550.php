 ...
 */
final class Version20230428141550 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation ADD CONSTRAINT FK_42C84955C8121CE9 FOREIGN KEY (nom_id) REFERENCES evenement (id)');
