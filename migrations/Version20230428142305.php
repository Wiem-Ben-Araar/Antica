 ...
 */
final class Version20230428142305 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation ADD evenement_nom VARCHAR(255) DEFAULT NULL, DROP evenement_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation ADD evenement_id INT DEFAULT NULL, DROP evenement_nom');
