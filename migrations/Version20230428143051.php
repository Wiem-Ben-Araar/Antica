 ...
 */
final class Version20230428143051 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation ADD evenement_id INT DEFAULT NULL, ADD nom VARCHAR(255) NOT NULL, DROP evenement_nom');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation ADD evenement_nom VARCHAR(255) DEFAULT NULL, DROP evenement_id, DROP nom');
    }
}
