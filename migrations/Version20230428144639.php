 ...
 */
final class Version20230428144639 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX evenement ON reservation');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation CHANGE evenement_nom evenement_nom VARCHAR(17) NOT NULL');
        $this->addSql('CREATE INDEX evenement ON reservation (evenement_nom)');
    }
}
